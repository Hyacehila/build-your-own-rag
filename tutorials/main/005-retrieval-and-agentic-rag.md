...
上一章：[Chunk 与增强层：为检索准备资料](004-chunks-and-enrichment.md) · [返回总目录](../../README.md#主线教程目录) · 下一章：[数据库存储与结构化回查](006-databases-and-source-lookup.md)
...
*相关数据库方案见[第六篇：数据库存储与结构化回查](006-databases-and-source-lookup.md)。*
